  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2 mb-5">
        ...
        <span className="text-muted-foreground text-xs">/</span>
        <span className="text-xs text-foreground font-medium">CASE-0847</span>
      </div>
        ...
        <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-6">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 mb-3 flex-wrap">
              ...
              <StatusBadge status={escalated ? 'Escalated' : 'Investigating'} />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                },
                {
                  ...
                  value: escalated ? 'Senior Director' : 'Priya Mehta',
                  mono: false,
                },
                {
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-28 h-28">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-2xl font-bold font-mono text-risk-critical risk-score-font">
                    {riskScore}
                  </span>
        ...
        <div className="mt-5 pt-5 border-t border-border">
          <div className="flex items-center gap-3 overflow-x-auto scrollbar-thin pb-1">
            {[
              ...
              { id: 'step-invest', label: 'Investigating', date: '11-Jul 08:30', active: !escalated, done: escalated },
              { id: 'step-sar', label: 'SAR Pending', date: generated ? '11-Jul 12:10' : '—', done: generated },
              { id: 'step-filed', label: 'SAR Filed', date: '—', done: false },
            ]?.map((step, i) => (
      ...
      >
        {!generated ? (
          ...
          <div className="text-center py-4">
            ...
            <p className="text-xs text-muted-foreground mb-4">
              SAR-2026-0847 is ready for review and filing with FIU-IND
            </p>
        ...
        {!escalated ? (
          ...
          <div className="text-center py-4">
            ...
            <p className="text-xs text-muted-foreground mb-1">
              CASE-0847 has been escalated to the Senior Compliance Director.
            </p>
      ...
      <Modal
        ...
        title="Request Deadline Extension — CASE-0847"
        size="sm"
      >
        {!extensionSubmitted ? (
          <div className="space-y-4">
